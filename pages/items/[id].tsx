    ...
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="flex cursor-pointer items-center space-x-3 border-b py-3">
          ...
          <div>
            <p className="text-gray-800">Steve Jebs</p>
        ...
        <div className="mt-5">
          ...
          <span className="mt-3 block text-3xl text-gray-800">$140</span>
          {/* text-base는 text를 기초 상태로 만들어준다. */}
      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              <div className="mb-4 h-56 w-full bg-slate-400" />
